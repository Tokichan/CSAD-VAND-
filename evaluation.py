...
def run(module_path: str, class_name: str, weights_path: str, dataset_path: str, category: str) -> None:
    ...
    datamodule = MVTecLoco(root=dataset_path, eval_batch_size=1, image_size=(256, 256), category=category)
    datamodule.setup()
...
if __name__ == "__main__":
    ...
    # python evaluation.py --module_path vand_model --class_name CSAD --dataset_path C:\Users\kev30\Desktop\anomaly\EfficientAD-res\datasets\mvtec_loco_anomaly_detection  --category screw_bag
